...
public class LabelEnumType implements DynamicParameterizedType, UserType{
	...
	public void setParameterValues(Properties parameters) {
		...
		//System.out.println("enumClass.getClass().getName() = " + enumClass.getName());
	}
	//DynamicParameterizedType
	...
	@Override
	public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor sharedSessionContractImplementor, Object o)
