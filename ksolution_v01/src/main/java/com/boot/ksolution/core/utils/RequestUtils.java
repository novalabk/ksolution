...
public class RequestUtils {
    ...
    public String getMessage(HttpServletRequest request, String id) {
    	return MessageUtils.getMessage(request, id, null);
    }
    ...
    public static Locale getLocale(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(language)) {
            ...
            //System.out.println("localeCookie = " + localeCookie);
