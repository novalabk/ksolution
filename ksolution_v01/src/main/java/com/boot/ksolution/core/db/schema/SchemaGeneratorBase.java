package com.boot.ksolution.core.db.schema;
...
public class SchemaGeneratorBase {
    ...
    protected Metadata getMetaData() {
    	...
    	prop.put("hibernate.connection.username", environment.getProperty("ksolution.dataSource.username", ""));
        prop.put("hibernate.connection.password", environment.getProperty("ksolution.dataSource.password", ""));
        prop.put("hibernate.connection.url", environment.getProperty("ksolution.dataSource.url", ""));
        ...
        Reflections reflections = new Reflections(ksolutionContextConfig.getBasePackageName());
