...
public class SchemaGenerator extends SchemaGeneratorBase{
	...
	public void createSchema() throws IOException, ClassNotFoundException {
		...
		//System.out.println("scriptOutputPath = " + scriptOutputPath);
		/*
        ...
        */
        ...
        for (String convertedDDL : convertedDDLs) {
            try {
                ...
                System.out.println("ok = " + convertedDDL.toUpperCase());
            } catch (Exception e) {
            	System.out.println("warning = " + convertedDDL.toUpperCase());
             //   e.printStackTrace();
            }
        }
	...
	/** create 문을 position순서대로 column을 배치하기 위해 별 의미가 있나?
	 * @param ddl
	 * @return
