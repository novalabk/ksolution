                ...
                <ax:form name="formView01">
                    ...
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px"> 
                        ...
                        <ax:tr labelWidth="120px">
                            ...
                            <ax:td label="소속" width="300px">
                                <input type="text" name="belong" data-ax-path="belong" maxlength="50" title="소속" class="form-control" value=""/>
                            </ax:td>
                            
                             <ax:td label="권한 만료일" width="300px">
                             <div class="input-group" data-ax5picker="date">
                                <input type="text" class="form-control" data-ax-path="dueEndDate" placeholder="yyyy-mm-dd">
                              </div>
                            </ax:td>
                        ...
                        <ax:tr labelWidth="120px">
                            ...
                            <%-- <ax:td label="ax.admin.user.account.status" width="220px" labelWidth="120px" >
                                <ax:common-code groupCd="USE_DUE" dataPath="useDue"/>
                            </ax:td> --%>
                            
                            <ax:td label="ax.admin.user.account.status" width="220px" labelWidth="120px" style="display:none">
                    ...
                    <div class="H5"></div>
                    <div class="ax-button-group sm" style="display:none">
                        <div class="left">
                            <h3><ax:lang id="ax.admin.user.menu.group.setting"/></h3>
                        </div>
                    </div>
                    <ax:tbl clazz="ax-form-tbl" style="display:none">
                        <ax:tr>
                    ...
                    <div data-ax5grid="grid-view-02" style="height: 300px;display:none"></div>
