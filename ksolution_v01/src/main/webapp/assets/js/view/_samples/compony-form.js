...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    PAGE_SAVE: function (caller, act, data) {
        if (caller.formView01.validate()) {
            ...
            var sendData = {
            	"componyList" : [parentData],
                "userList": childList
            };
            console.log("sendData sss " , sendData);
            
            axboot
                .call({
                    type: "PUT", url:"/api/v1/test/company", data: JSON.stringify(sendData),
                    callback: function (res) {
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "companyId", label: "companyId", width: 80, align: "left"},
                {key: "name", label: "name", width: 120, align: "left"},
                {key: "sector", label: "sector", width: 70, align: "center"},
                {key: "location", label: "location", width: 70, align: "center"}
            ],
            body: {
                onClick: function () {
...
fnObj.gridView02 = axboot.viewExtend(axboot.gridView, {
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "userId", label: "userId", width: 80, align: "left", editor: "text"},
                {key: "name", label: "name", width: 120, align: "left", editor: "text"},
                {key: "email", label: "email", width: 70, align: "center", editor: "text"}
            ],
            body: {
                onClick: function () {
                    //this.self.select(this.dindex);
