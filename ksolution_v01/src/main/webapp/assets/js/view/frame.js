...
fnObj.tabView = axboot.viewExtend({
    ...
    closeAndOpen : function(menuId, openMenuId){
    	var findedIndex = ax5.util.search(this.list, function () {
            return this.menuId == '19';
        ...
        if(findedIndex > -1){
            ...
            this.open(parent.fnObj.tabView.list[0]);
    ...
    replace: function(item){
    	...
    	var currentItem = this.list[findedIndex];
    	currentItem.menuId = item.menuId;
    	currentItem.id = item.id;
    	currentItem.menuNm= item.menuNm;
        currentItem.progPh = item.progPh;
    ...
    open: function (item) {
        ...
        if (findedIndex < 0) {
            ...
            console.log("this.frameTarget", this.frameTarget); 
