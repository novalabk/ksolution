...
//                    console.log('onClick call!!!!!!!!!!!!!!!!!!!!!1' + this.dindex);
                ...
                onDBLClick: function () {
                	//console.log(this);
                	url = '/Windchill/netmarkets/jsp/psb/cidspsb-iframe.jsp?ContainerOid=OR:wt.pdmlink.PDMLinkProduct:68423&oid=' + this.item.oid + '&u8=1'  
                	window.open(url, "", "width=800, height=600,  scrollbars=1, menubar=1");
