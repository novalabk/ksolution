<%@ tag import="com.boot.ksolution.core.utils.TagUtils" %>
<%@ tag import="org.apache.commons.lang3.StringUtils" %>
<%@ tag import="com.boot.ksolution.core.utils.MessageUtils" %>
...
<div data-ax-td="${id}" id="${id}" class="${clazz}" style="<%=style%>">
    ...
    <div data-ax-td-wrap="" style="vertical-align:middle;<%=tdWrapStyle%>">
        <jsp:doBody/>
    </div>
</div>
<%
