<%@ tag import="com.ksolution.common.utils.CommonCodeUtils" %>
<%@ tag import="com.boot.ksolution.core.utils.ContextUtil" %>
<%@ tag import="com.boot.ksolution.core.utils.PhaseUtils" %>
...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/assets/plugins/jquery-file-download/src/Scripts/jquery.fileDownload.js' />"></script>
    <script type="text/javascript" src="<c:url value='/ksolution.config.js' />"></script>
